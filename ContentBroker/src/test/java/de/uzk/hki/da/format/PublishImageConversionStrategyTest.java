...
public class PublishImageConversionStrategyTest {
	...
	Path workAreaRootPath = Path.make(TestFolders.TEST_ROOT_FORMAT,"PublishImageConversionStrategyTests");
	...
	public void testWatermarkWithRealImage() throws FileNotFoundException {
		...
		Document dom = XPathUtils.parseDom(TestFolders.TEST_ROOT_FORMAT+"/PublishImageConversionStrategyTests/premis.xml");
		if (dom==null){
