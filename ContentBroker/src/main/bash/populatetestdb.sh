...
then
	sqls=(
        ...
        "INSERT INTO second_stage_scans (id,puid,allowed_values,format_identifier_script_name) VALUES (1,'fmt/101','EAD,METS','de.uzk.hki.da.ff.PublicationMetadataSubformatIdentifier');"
	)
fi
