...
then
	sqls=(
		...
		"DELETE FROM users;"
		"DELETE FROM Role;"
		"INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (1,'TEST','TEST',FALSE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (2,'DEFAULT','DEFAULT',TRUE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (3,'PRESENTER','PRESENTER',TRUE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (4,'rods','rods',FALSE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (5,'CI_ADMIN','CI_ADMIN',FALSE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
		...
		"INSERT INTO psystem (id,urn_name_space,sidecar_extensions,pres_server,open_collection_name,closed_collection_name,uris_aggr,uris_cho,uris_file,min_repls,uris_local,admin_id) VALUES (1,'urn:nbn:de:danrw','xmp;txt;xml','localnode','danrw','danrw-closed','http://data.danrw.de/aggregation','http://data.danrw.de/cho','http://data.danrw.de/file',1,'info:',5);"
		"INSERT INTO nodes (id,urn_index,name,admin_id) values (1,0,'localnode',5);"
