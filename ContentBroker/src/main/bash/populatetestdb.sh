...
then
	...
	"DELETE FROM second_stage_scans;"
		...
		"DELETE FROM users;"
		"DELETE FROM Role;"
	"INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled) values (1,'TEST','TEST',0,0,0,1);"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled) values (2,'DEFAULT','DEFAULT',1,0,0,1);"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled) values (3,'PRESENTER','PRESENTER',1,0,0,1);"
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled) values (4,'rods','rods',0,0,0,1);"
