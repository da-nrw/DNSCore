...
then
	sqls=(
        ...
        "INSERT INTO users (id,short_name,username,accountlocked,accountexpired,passwordexpired,enabled,email_contact) values (5,'DAADMIN','DAADMIN',FALSE,FALSE,FALSE,TRUE,'noreply@danrw.de');"
