...
then
	sqls=(
		...
		"INSERT INTO preservation_system (id,urn_name_space,pres_server,open_collection_name,closed_collection_name,uris_aggr,uris_cho,uris_file,min_repls,uris_local,admin_id) VALUES (1,'urn:nbn:de:danrw','localnode','collection-open','collection-closed','http://data.danrw.de/aggregation','http://data.danrw.de/cho','http://data.danrw.de/file',2,'info:',5);"
		"INSERT INTO nodes (id,urn_index,name,identifier,admin_id,psystem_id) values (1,0,'localnode','c-i',5,1);"
		"INSERT INTO nodes (id,urn_index,name,identifier,admin_id,psystem_id) values (2,0,'cooperatingnode','c-i/CN',6,1);"	
