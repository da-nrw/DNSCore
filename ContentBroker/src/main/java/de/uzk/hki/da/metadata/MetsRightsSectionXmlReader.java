 ...
 *
 */
public class MetsRightsSectionXmlReader {
	
	/** The logger. */
	private static Logger logger = LoggerFactory.getLogger(MetsRightsSectionXmlReader.class);
	 ...
	 */
	public MetsRightsSectionXmlReader() {
