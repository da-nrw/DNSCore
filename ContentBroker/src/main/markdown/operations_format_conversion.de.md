...
3. Das Format der Eingangsdatei gilt als "bekannt". D.h. für diese PUID sind keine Konverionsroutinen eingetragen. Die Datei wird im gesamten Workflow des DNSCore nicht konvertiert, die PUID bleibt immer gleich.
