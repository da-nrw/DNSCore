...
* Job [states](administration-troubleshooting.md). How to deal with jobs in error states ([deutsch](administration-troubleshooting_de.md) | [english] (administration-troubleshooting.md)).
