...
public class ATSipBuilderCliMets {
	...
	public void testBuildSingleSipCorrectReferences() throws IOException {
	    ...
	    while ((s = stdInput.readLine()) != null) {
	         ...
	         if(s.contains("Identified metadata file") && s.contains("DNSCore/SIP-Builder/src/test/resources/at/ATBuildSingleMetsSip/export_mets.xml=METS}")) {
	...
	public void testBuildSingleSipErrorWrongReferences() throws IOException {
		...
		File source = new File(sourceDir, "ATBuildSingleMetsSipWrongRefErrorCase/ATBuildSingleMetsSipWrongReferences");
	    ...
	    while ((s = stdInput.readLine()) != null) {
	         ...
	         if(s.contains("Identified metadata file") 
	        		 && s.contains("DNSCore/SIP-Builder/src/test/resources/at/ATBuildSingleMetsSipWrongRefErrorCase/ATBuildSingleMetsSipWrongReferences/export_mets.xml=METS")) {
	        	 identifiedMetadataType = true;
	         }
