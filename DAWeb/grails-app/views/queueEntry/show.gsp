...
<html>
	...
	<body>
		<a href="#show-queueEntry" class="skip" tabindex="-1">
		...
		<div id="show-queueEntry" class="content scaffold-show" role="main">
			...
			<g:if test="${systemInfo}">
				<li class="fieldcontain">
					<span id="urn-label" class="property-label">
						<g:message code="queueEntry.id.label" default="Systeminformation" />
					</span>
			...
			<g:if test="${queueEntryInstance?.id}">
				<li class="fieldcontain">
					<span id="urn-label" class="property-label">
						<g:message code="queueEntry.id.label" default="Job-Id" />
					</span>
			...
			<g:if test="${queueEntryInstance?.obj.identifier}">
				<li class="fieldcontain">
					<span id="urn-label" class="property-label">
						<g:message code="queueEntry.id.label" default="Identifier" />
					</span>
					<span class="property-value" aria-labelledby="urn-label">
						<g:fieldValue bean="${queueEntryInstance.obj}" field="identifier"/>
					</span>
				</li>
			</g:if>
			<g:if test="${queueEntryInstance?.obj.getIdAsString()}">
				<li class="fieldcontain">
					<span id="urn-label" class="property-label">
						<g:message code="object.id.label" default="Object-Id" />
					</span>
			...
			<g:if test="${queueEntryInstance?.status}">
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="status-label">
						<g:fieldValue bean="${queueEntryInstance}" field="status"/>
					</span>
				</li>
			</g:if>
			<g:if test="${queueEntryInstance?.obj.urn}">
				<li class="fieldcontain">
					...
					<span class="property-value" aria-labelledby="urn-label">
						<g:fieldValue bean="${queueEntryInstance.obj}" field="urn"/>
					</span>
				</li>
			</g:if>
			<g:if test="${queueEntryInstance?.obj.getUser().getShortName()}">
				<li class="fieldcontain">
					<span id="contractorShortName-label" class="property-label">
