...
<html>
	...
	<body>
		<a href="#show-conversionPolicies" class="skip" tabindex="-1">
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li>
					<g:link class="list" action="list" onclick="history.back(-1)">
		...
		<div id="show-conversionPolicies" class="content scaffold-show" role="main">
			...
			<ol class="property-list conversionPolicies">
				<g:if test="${conversionPoliciesInstance?.id}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
				...
				<g:if test="${conversionPoliciesInstance?.conversion_routine}">
					<li class="fieldcontain">
						<span id="conversion_routine-label" class="property-label">
							<g:message code="conversionPolicies.conversion_routine.label" default="konversionroutine" />
						</span>
				...
				<g:if test="${conversionPoliciesInstance?.source_format}">
					<li class="fieldcontain">
						<span id="source_format-label" class="property-label">
				...
				<g:if test="${conversionPoliciesInstance?.conversion_routine?.target_suffix}">
					<li class="fieldcontain">
						<span id="source_format-label" class="property-label">
							<g:message code="conversionPolicies.conversion_routine.target_suffix.label" default="Zielformat" />
						</span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:if test="${admin}">
						<g:link class="edit" action="edit" resource="${conversionPoliciesInstance}">
