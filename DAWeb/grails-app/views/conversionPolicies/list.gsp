...
<html>
	...
	<body>
		<a href="#list-conversionPolicies" class="skip" tabindex="-1">
		...
		<div id="list-conversionPolicies" class="content scaffold-list" role="main">
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th>
								<g:message code="conversionPolicies.conversion_routine.label" default="Zielformat" />
							</th>
							<th>
					...
					<g:each in="${conversionPoliciesInstanceList}" status="i" var="conversionPoliciesInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								<g:link action="show" id="${conversionPoliciesInstance.id}">${conversionPoliciesInstance.id}</g:link>
							</td>
			...
			<div class="pagination">
				<g:paginate controller="conversionPolicies" action="list" total="${conversionPoliciesInstanceTotal}"  />
			</div>
		</div>
	</body>
</html>
