...
<html>
	...
	<body>
		<a href="#list-preservationSystem" class="skip" tabindex="-1">
			...
			<table>
				...
				<g:each in="${preservationSystemInstanceList}" status="i" var="preservationSystemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						<td>
							<g:link action="show" id="${preservationSystemInstance.id}">${fieldValue(bean: preservationSystemInstance, field: "minRepls")}</g:link>
						</td>
