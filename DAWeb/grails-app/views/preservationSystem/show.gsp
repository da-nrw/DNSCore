		...
		<div id="show-preservationSystem" class="content scaffold-show" role="main">
			...
			<ol class="property-list preservationSystem">
				...
				<g:if test="${preservationSystemInstance?.sidecarExtensions}">
					<li class="fieldcontain">
						<span id="sidecarExtensions-label" class="property-label">
							<g:message code="preservationSystem.sidecarExtensions.label" default="Sidecar Extensions" />
						</span>
						<span class="property-value" aria-labelledby="sidecarExtensions-label">
							<g:fieldValue bean="${preservationSystemInstance}" field="sidecarExtensions"/>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${preservationSystemInstance?.urnNameSpace}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="urnNameSpace-label">
							<g:fieldValue bean="${preservationSystemInstance}" field="urnNameSpace"/>
						</span>
					</li>
				</g:if>
			</ol>
			<g:form url="[resource:preservationSystemInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${preservationSystemInstance}">
