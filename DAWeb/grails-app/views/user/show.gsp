			...
			<ol class="property-list user">
				<g:if test="${userInstance?.email_contact}">
					<li class="fieldcontain">
						<span id="email_contact-label" class="property-label">
							<g:message code="user.email_contact.label" default="Emailcontact" />
						</span>
						<span class="property-value" aria-labelledby="email_contact-label">
							<g:fieldValue bean="${userInstance}" field="email_contact"/>
						</span>
					</li>
				</g:if>
				<g:if test="${userInstance?.shortName}">
					<li class="fieldcontain">
						<span id="shortName-label" class="property-label">
							<g:message code="user.shortName.label" default="Short Name" />
						</span>
						<span class="property-value" aria-labelledby="shortName-label">
							<g:fieldValue bean="${userInstance}" field="shortName"/>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${userInstance?.forbidden_nodes}">
					<li class="fieldcontain">
						<span id="forbidden_nodes-label" class="property-label">
							<g:message code="user.forbidden_nodes.label" default="Forbiddennodes" />
						</span>
						<span class="property-value" aria-labelledby="forbidden_nodes-label">
							<g:fieldValue bean="${userInstance}" field="forbidden_nodes"/>
						</span>
					</li>
				</g:if>
