<html>
	...
	<h1>Hinweise zur automatischen Retrievalanforderung an die DNS </h1>
		<ul class="property-list object">
			...
			<li>
				<span class="property-value">
					...
					<b>https://Servername
						<g:createLink controller="automatedRetrieval" action="queueForRetrievalJSON"/>
					</b>
					<br>
				</span>
			</li>
			<span class="property-value">
				<li>Als Antwort erhalten Sie ein maschinenlesbares Ergebnis (JSON) über die Erstellung eines Abfragevorgangs
					<br>
				</li>
			</span>
		</ul>
		...
		$.ajax({
		    ...
		    url: '<g:createLink controller="automatedRetrieval"
				action="queueForRetrievalJSON" />',
		    success:
