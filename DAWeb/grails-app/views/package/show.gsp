		...
		<div id="show-package" class="content scaffold-show" role="main">
			...
			<ol class="property-list object">
				<g:if test="${packageInstance?.id}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
							<g:message code="package.id.label" default="Id" />
						</span>
				...
				<g:if test="${packageInstance?.checksum}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
							<g:message code="package.checksum.label" default="Checksum" />
						</span>
				...
				<g:if test="${packageInstance?.status}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
							<g:message code="package.status.label" default="Status" />
						</span>
				...
				<g:if test="${packageInstance?.last_checked}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
							<g:message code="package.last_checked.label" default="Letzte Überprüfung" />
						</span>
