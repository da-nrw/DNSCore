	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li>
					<a class="list" href="<g:createLink controller="object" action="list" />">Liste der AIP</a>
				</li>
			</ul>
		</div>
				...
				<g:if test="${objectInstance?.user}">
					<li class="fieldcontain">
						<span id="contractor-label" class="property-label">
							<g:message code="object.user.label" default="Contractor" />
						</span>
				...
				<g:if test="${objectInstance?.urn}">
					<li class="fieldcontain">
						...
						<g:if test="${objectInstance.published_flag==1}">
							<g:link url="${objectInstance.getPublicPresLink() }" target="_blank">
								<span class="property-value" aria-labelledby="urn-label">Öffentliche Derivate (PIP)</span>
							</g:link>
						</g:if>
						<g:if test="${objectInstance.published_flag==2}">
							<g:link url="${objectInstance.getInstPresLink() }" target="_blank">
							<span class="property-value" aria-labelledby="urn-label">Institutionelle Derivate (PIP)</span>
						</g:link>
						</g:if>
